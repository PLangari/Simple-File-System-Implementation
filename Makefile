...
SOURCES= disk_emu.c utils.c sfs_inode.c test.c sfs_dir.c sfs_api.c sfs_test0.c sfs_api.h
# SOURCES= disk_emu.c utils.c sfs_inode.c test.c sfs_dir.c sfs_api.c sfs_test1.c sfs_api.h
# SOURCES= disk_emu.c utils.c sfs_inode.c test.c sfs_dir.c sfs_api.c sfs_test2.c sfs_api.h
